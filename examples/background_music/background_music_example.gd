...
const MUSIC_1 = preload("res://examples/music_crossfade/Blood_And_Myth_LOOP_58bpm.wav")
const MUSIC_2 = preload("res://examples/music_crossfade/Chariot_Battle_LOOP_175bpm.wav")
